...
Get them from **[GitHub Releases](https://github.com/carlok/labzero/releases)** (latest tag, e.g. `v0.5.3`). Each upload has a `.sha256` sidecar; `SHA256SUMS` lists all files.
...
Maintainers: push a semver tag to publish — `git tag v0.5.3 && git push origin v0.5.3` runs [`.github/workflows/release.yml`](.github/workflows/release.yml).
