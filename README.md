...
Get them from **[GitHub Releases](https://github.com/carlok/labzero/releases)** (latest tag, e.g. `v0.6.0`). Each upload has a `.sha256` sidecar; `SHA256SUMS` lists all files.
...
Maintainers: push a semver tag to publish — `git tag v0.6.0 && git push origin v0.6.0` runs [`.github/workflows/release.yml`](.github/workflows/release.yml).
